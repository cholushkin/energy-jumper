...
{
    public class SoundManager : Singleton<SoundManager>, ICoroutineControl
    {
        /// <summary>
        ...
        private void GrowPool(int num)
        {
            ...
            SoundPlayer CreateSoundPlayer()
            {
                ...
                var soundPlayer = new SoundPlayer(audioSource, MixerGroup, this, _log);
        ...
        private class SoundPlayer
        {
            ...
            public SoundPlayer(AudioSource audioSource, AudioMixerGroup mixerGroup, ICoroutineControl coroutineControl, SoundManagerDebugLogger log)
            {
                _log = log;
